...
const FloorRegistration = () => {
  ...
  const userSchema = yup.object().shape({
    floorId: yup.number().required("required").positive().integer(),
  ...
  return (
    <>
      <Header title="Floor Registration" />
              ...
              >
                <Grid item md={12} sm={12} xs={12}>
                  <TextField
                    ...
                    name="floorId"
                    error={!!touched.floorId && !!errors.floorId}
...
export default FloorRegistration;
